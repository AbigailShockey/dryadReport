...
Key antibiotic resistance genes identified in each sample are shown in the table below. Identity and coverage compared to the reference gene is shown in the right two columns.
